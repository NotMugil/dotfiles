...
function make_literal() {
    ...
    [[ "$caches" == "" ]] \
    && print '(box :class "notifications-empty-box" :height 300 :orientation "vertical" :space-evenly "false" (label :vexpand true :valign "center" :wrap true :class "notifications-empty-label" :text "No Notifications"))' \
